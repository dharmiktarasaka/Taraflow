    ...
    <>
      ...
      >
        ...
        <div className="px-4 py-4 border-b border-zinc-800/50">
          <div className="flex items-center justify-between p-2.5 bg-zinc-900/40 rounded-xl border border-zinc-800/60 hover:bg-zinc-900/60 transition-colors cursor-pointer group">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200 group-hover:text-zinc-950 dark:group-hover:text-white transition-colors">Tarasaka Media</p>
              </div>
            </div>
